...
export const createBasicDataValidator = [jwtValidator, check('name', 'Name is required').not().isEmpty(), check('value', 'Value is required').isNumeric(), check('category', 'Category is required').not().isEmpty(), validationFields];
